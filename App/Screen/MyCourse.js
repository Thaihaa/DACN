...
export default function MyCourse() {
  ...
  return (
    <View style={{flex:1}}>
      <View style={{height:160,backgroundColor:Colors.MINT_GREEN,padding:30}}>
        <Text style={{fontFamily:'smbold',color:Colors.BLACK,fontSize:30}}>My Course</Text>
      </View>
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={{margin:8,padding:5}}
